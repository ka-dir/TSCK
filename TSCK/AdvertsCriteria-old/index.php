...
<form id ="CriteriaForm" action="" method="post">
	<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example" >
		...
		$query=mysqli_query($dbconnection, "SELECT a.id,v.vacancy_id AS advert_id,v.advert_no,v.post_vacancy,c.criteria_type,aw.award,cs.course_desc,s.name AS specialization 
				...
				<td>
					  <div class="btn-group" role="group">
					    ...
					    <ul class="dropdown-menu">						     
						  ...
						  <input  type="submit" name="delete_submit" value="Delete" style="background: none;margin: 0;padding: 0;color: #0088cc;text-decoration: none;  font-weight: 300;cursor: pointer;background: none;border: none;width:70%; text-align:center;" />
