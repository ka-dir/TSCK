...
//year of graduation help us calculate how long seens graduation;
                    ...
                    <div class="center" >
                        ...
                        <h5 class="fw-light" style="background: gray;display: block;align-content: center;text-decoration: underline overline dotted red;font-weight: bolder;font-size: medium;font-family: 'Agency FB'">ACADEMICS ATTACHMENT</h5>



                        <?php

                        $sql_academics = "SELECT upload_cert FROM academic_qualification WHERE id_number='$varIdNumber'";
                        $results_academics =  mysqli_query($conn,$sql_academics);
                        while($row_academics = mysqli_fetch_array($results_academics)){


                            ?>

                            <embed type="application/pdf" width="100%" height="1000px";   src="././sectionFour/uploads/<?php echo $row_academics['upload_cert'];  ?>#toolbar=1&navpanes=0&scrollbar=0" >   </embed>
                            <br><hr>
                        <?php } ?>
                    </div>
                </div>
                ...
                <div class="center" >
                    ...
                    while($row_prof_qualification = mysqli_fetch_array($results_prof_qualification)){
                        ...
                        <embed type="application/pdf" width="100%" height="1000px";   src="././sectionFive/uploads/<?php echo $row_prof_qualification['upload_cert'];  ?>#toolbar=1&navpanes=0&scrollbar=0"  </embed>
                    <?php } ?>
            ...
            <div class="center" >
                ...
                while($row_relevant_courses = mysqli_fetch_array($results_relevant_courses)){
                    ...
                    <embed type="application/pdf" width="100%" height="1000px";   src="././SectionSix/uploads/<?php echo $row_relevant_courses['upload_cert'];  ?>#toolbar=1&navpanes=0&scrollbar=0"  </embed>
                <?php } ?>
    ...
    <div class="center" >
        <div class="row" >
            ...
            $sql_current_membership = "SELECT upload_id FROM applicant_details WHERE id_no='$varIdNumber'";
            $results_current_membership =  mysqli_query($conn,$sql_current_membership);
            while($row_current_membership = mysqli_fetch_array($results_current_membership)){
                ...
                <embed type="application/pdf" width="100%" height="1000px";   src="././sectionTwo/uploads/<?php echo $row_current_membership['upload_id'];  ?>#toolbar=1&navpanes=0&scrollbar=0"  </embed>
            <?php } ?>
