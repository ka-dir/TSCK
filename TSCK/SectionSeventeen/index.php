...
$sql="
SELECT DISTINCT
a.title,a.S_name,a.F_name,a.O_name,a.DOB,a.id_no,a.gender,a.nationality,a.county,a.sub_county, a.current_employer_name, a.position_held,
...
WHERE a.id_no='".$varIdNumber."'";
	...
	while($row = mysqli_fetch_array($result))
	{
		...
		$current_employer_name=$row['current_employer_name'];
...
echo $AGE;
		...
		<td style="width: 16%;"><label>Current Employer</label><p><?php echo  $current_employer_name;?></p></td>
		<td style="width: 16%;"><label>Position Held At Current Employment</label><p><?php echo  $position_held;?></p></td>
	</tr>
	<tr>
