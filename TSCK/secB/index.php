...
//Insert New Record
   if(isset($_POST['btnIinsertNew']))
   {
	...
	$sql = "INSERT INTO $varTableName (firstname, lastname, middlename, address, email)
...
<form action="" method="post">
	<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example" >
		...
		$query=mysqli_query($dbconnection, "select * from $varTableName ORDER BY member_id DESC")or die(mysqli_error());
