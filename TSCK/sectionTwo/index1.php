<?php
include('../TSCKN/includes/dbConfig.php');
...
//echo "\">";
        ...
        <div class="row">
            ...
            <div class="form-group col-md-2">
                ...
                <input type="text" onKeyPress="return ValidateAlpha(event);" name="postal_code"
                       value="<?php
                       echo $varPostalCode;
            ...
            <div class="form-group col-md-2">
                ...
                <input type="email" name="email" required="required" value="<?php echo $email ?>" placeholder="e.g abc@tsc.go.ke">
            </div>
...
//echo $varHomecounty;
        ...
        <div class="row">
            ...
            <div class="form-group col-md-2">
                ...
                <input type="text" value="<?php echo $alt_tel_no;?>" onkeypress="return blockSpecialChar(event)" name="mobile" maxlength="11"
                       placeholder="" required="required"
                >
        ...
        <div class="row">
            ...
            <div class="form-group col-md-2">
                ...
                <input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="yesCheck" required="required"
                       value="YES"/>Yes
                <input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="noCheck" required="required"
                       value="NO"/>No
            </div>
        </div>
        ...
        while($row_applicant_details = mysqli_fetch_array($results_applicant_details)){
            ...
            <img style="height: 100%;width: 100%" src="././sectionTwo/uploads/<?php echo $row_applicant_details['upload_id'];  ?>"  </img>
        <?php }


        if ($row_applicant_details['upload_id'] == NULL) {
            echo "  NOT uploaded";
        } else {
        ?>
        <hr>
        <label for="id_upload">Upload Id</label>
        <span class="controls" >  <input name="uploadfile"style="background-color: lavender; border-radius:20px"  type="file" required="required" value=""  />
  </span>
</div>
<hr> ;
<?php
...
<div class="row">
    <div class="col-md-4">
        <hr>
        <label for="id_upload">Upload Id</label>
        <span class="controls" >  <input name="uploadfile"style="background-color: lavender; border-radius:20px"  type="file" required="required" value=""  /></span>
    </div>
    <hr>
    ...
    <div class="col-md-4">
        ...
        ?>
        <hr>
        <a href="?upload_id=<?php echo $varIdNumber  ?>" class="btn btn-danger" name="btndeleteid"><span class="glyphicon glyphicon-trash"></span> Delete Id</a>
        <hr>
...
<div class="row">
    <div class="form-group col-md-4">
        ...
        <a href="./secOne.php" role="button" style="background-color:#314C95;" class="btn btn-success pull-left"
           style="margin-left:2%;"><< Previous</a>
    </div>
    <div class="form-group col-md-4">
        <input type="submit" style="margin-left:-12%;" name="btnSubmitProfile" value="Save">
    </div>
    <div class="form-group col-md-4">
        <input type="submit" style="margin-right:100%;width:80px;height=2%;" name="btnSubmitProfile"
               value="Next >>" class="btn btn-success pull-right">
    </div>
