...
<div class="container" style="width:auto; margin-left:-5px;">
                    ...
                    <div class="input-group custom-search-form">
                        <form class="form-inline" method="POST" action="">
                            <div class="input-group col-md-12">
                                <input type="text" class="form-control" placeholder="Search Advert NO..." name="keyword" required="required">
    ...
    <div class="row">
        ...
        <div class="col-md-14">
            <button class="btn btn-info btn-xs align-left" data-toggle="modal" data-target="#myModal" style="margin-left: 65%">New Advert <i class="glyphicon glyphicon-plus"></i></button>
        </div>
    </div>
    ...
    <form id ="CriteriaForm"  name="CriteriaForm"  action="" method="post">
        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example" >
            ...
            <tr>
                ...
                <!--th style="text-align:center; font-size:12px;">Closing Date</th>
                <th style="text-align:center; font-size:12px;">Category</th>
                <th style="text-align:center; font-size:12px;">Pay Type</th>
                <th style="text-align:center; font-size:12px;">Currency</th>
                <th style="text-align:center; font-size:12px;">Basic Salary</th>
                <th style="text-align:left; font-size:12px;">House Allowance</th>-->
            ...
            while($row=mysqli_fetch_array($query))
            {
                ...
                <tr>
                    ...
                    <td style="text-align:center; font-size:12px;">
                        <button type="button" class="btn btn-primary">
                            <?php echo $category; ?> <span class="badge badge-light" style="color: red"><?php if($status == 1){ echo "Closed";}else{ echo "open";} ; ?></span>
                        </button>
                    </td>
                    <!--	<td style="text-align:center; font-size:12px;"><?php /*if($status == 1){ echo "Closed";}else{ echo "open";} ; */?></td>-->
                    <!--td style="text-align:center; font-size:12px;"><?php echo $duDate; ?></td>
                    ...
                    <td style="margin: 5%"  >
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <!--							<input   data-id="--><?php //echo $advert_no; ?><!--"  class='btn btn-info btn-xs advertinfo'   type="submit"  value="View-Advert"   style="background: none;margin: 0;padding: 0;color: #0088cc;text-decoration: none;  font-weight: 300;cursor: pointer;background: none;border: none;width:70%; text-align:center;"/>-->
                                <!--							<input  data-id="--><?php //echo $advert_no; ?><!--"    style="background: none;margin: 0;padding: 0;color: #0088cc;text-decoration: none;  font-weight: 300;cursor: pointer;background: none;border: none;width:70%; text-align:center;"  type="submit"  value="Publish-Advert"/>-->
                                <!---->
                                <!--							<a href="jobdetails.php?advert_no=--><?php//// echo $encode_advertno ?><!--">Details</a>-->
                                <!--                                <li>-->
                                <!--                                    <a data-toggle="modal" data-target="#myModal" href="#myModal?edit=--><?php //echo $advert_id;?><!--">Edit-Advert</a>-->
                                <!--                                </li>-->
                                <!--                                <li>-->
                                <!--                                    <a href="Adverts/delete.php?delete=--><?php //echo $advert_id;?><!--" style="color: red;" >Delete-Advert</a>-->
                                <!--                                </li> -->
                                <!---->
                                <!--                            </form>-->
						  ...
						  <input style="background: none;margin: 0;padding: 0;color: #0088cc;text-decoration: none;  font-weight: 300;cursor: pointer;background: none;border: none;width:70%; text-align:center;"  type="submit"  value="Criteria"/>-->
                                ...
                                <li><a class="btn btn-primary active" role="button" href="adverts-criteria.php?id=<?php echo $advert_id; ?>">View-Criteria</a></li>
                                <li><a class="btn btn-success active" href="view-applicants.php?id=<?php echo $advert_id; ?>&s=xyft">View-Submitted</a></li>
                                <li><a class="btn btn-info active" style="background-color: red" href="view-applicants.php?id=<?php echo $advert_id; ?>&s=tfyx">View-Not-Submitted</a></li>
                            </ul>
                        </div>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <form name="" method="POST" action="././Adverts/export.php">
                                        <input type="hidden" name="advert_no"  value="<?php echo $advert_no; ?>"/>
                                        <input type="submit" name="export"  value="Export csv" class="btn btn-success"  style="height:100%; width:100%;margin: auto;"  />
                                    </form>
                                </li>
                                ...
                                <li>
                                    <form name="" method="POST" action="././Adverts/pdfexport.php">
                                        <input type="hidden" name="advert_no"  value="<?php echo $advert_no; ?>"/>
                                        <input type="submit" name="pdf"  value="Export pdf" class="btn btn-danger"  style="height:100%; width:100%;margin: auto; background-color: red"  />
                                    </form>
                                </li>
                                <li>

                                    <a href="././Adverts/dashboard.php?xD=<?php echo $encode_advertno;?>" target="_dashboard" >dashboard</a>
            ...
            <div class="modal-body">
                <form method="post" action="Adverts/create_advert_process.php">
                    ...
                    <div class="row" style="margin-left: 0%;">
                        ...
                        <div class="form-group col-md-6">
                            <label>House Allowance</label>
                            <input type="number" name="house_allowance" placeholder="House Allowance" style="width: 95%" >
                        </div>
                    ...
                    <div class="row" style="margin-left: 0%;">
                        <div class="form-group col-md-6">
                            <label>Commuter Allowance</label>
                            <input type="number" name="commuter_allowance" placeholder="Commuter Allowance" style="width: 95%" >
                        </div>
                        <div class="form-group col-md-6">
                            <label>Leave Allowance</label>
                            <input type="number" name="leave_allowance" placeholder="Leave Allowance" style="width: 95%" >
                        </div>
                    </div>
                    <div class="form-group col-md-12">
                        <label>Medical Scheme</label>
                    ...
                    <div class="row">
                        <button type="submit" name="btn_add_advert" class="btn btn-success" style="margin-left: 5%; width: 20%;">ADD ADVERT</button>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
