...
elseif (isset($_POST['btnDelete'])) {
    ...
    <div class="container" style="width:100%; margin-left:-5px;">
        ...
        <form class="form-vertical" action="" method="post" enctype="multipart/form-data">
			...
			<?php
            $sql = mysqli_query($conn, "SELECT course_id,course_desc FROM courses ");
            while ($row = $sql->fetch_assoc()) {
                ...
                ?>
                    ...
                    <td>
                        <span class="controls">  <input name="uploadfile" type="file" required="required"
                                                        style=" font-weight:bold;" value=""/></span>
                    </td>
                    <td>
...
<input name="cert_year" id="txtGRADDate" onchange="TDateGraduate()" type="date" required="required"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#next_b").submit(function (e) {
                e.preventDefault();

                let otp = "<?php echo rand(100000, 999999);?>";
